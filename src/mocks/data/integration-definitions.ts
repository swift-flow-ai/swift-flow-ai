...
export const integrationDefinitions: IntegrationDefinition[] = [
  ...
  // ============================================================================
  {
    id: "approval",
    name: "Approval",
    displayName: "Approval / Human Task",
    description: "Request approval or human input in your workflow",
    category: "utilities",
    icon: "✅",
    logoUrl: "",
    version: "1.0.0",
    ...
    actions: [
      {
        ...
        description: "Send an approval request to one or more users",
        properties: [
          {
            key: "title",
          ...
          },
          {
            ...
            type: "text",
            required: true,
            placeholder: "e.g., MacBook Pro M3 + accessories for new hire",
          },
          {
            key: "assignees",
            label: "Approvers",
            description: "Users or pools who can approve this request",
            type: "multi-select",
            required: true,
            dynamicOptions: {
              endpoint: "/users",
          ...
          },
          {
            key: "dueDate",
            label: "Due Date",
            description: "When the approval is due",
            type: "datetime",
            required: false,
          },
          {
          ...
          },
          {
            ...
            description: "Force users to provide a reason when rejecting",
            type: "boolean",
            required: false,
            defaultValue: true,
          },
          {
            ...
            description: "Additional actions beyond Approve/Reject",
            type: "multi-select",
            required: false,
            options: [
        ...
        sampleOutput: {
          ...
          comment: "Approved - standard equipment for engineering role",
      ...
      {
        key: "collect_input",
        name: "Collect Human Input",
        description: "Pause workflow and collect input from a user",
        properties: [
          {
            key: "title",
            label: "Task Title",
            description: "Title of the input request",
            type: "text",
            required: true,
          ...
          },
          {
            ...
            type: "text",
            required: true,
            placeholder: "e.g., Please review and provide feedback",
          },
          {
            key: "assignee",
            label: "Assigned To",
            description: "User who should complete this task",
            type: "dropdown",
            required: true,
            dynamicOptions: {
              endpoint: "/users",
          ...
          },
          {
            ...
            type: "json",
            required: true,
            placeholder: '{"feedback": "text", "rating": "number"}',
          },
          {
            key: "timeout",
            label: "Timeout",
            description: "Auto-fail if no response within this time",
            type: "text",
            required: false,
        ...
        sampleOutput: {
          status: "completed",
          inputs: {
            feedback: "Contract terms look good, minor typo on page 3",
            rating: 4,
          },
          completedBy: {
            id: "usr_sarah",
    ...
    docsUrl: "https://docs.swiftflow.ai/utilities/approval",
    supportUrl: "https://support.swiftflow.ai",
    author: "Swift Flow AI",
    installCount: 15000,
    rating: 4.9,
...

  {
    ...
    description: "Add delays and scheduling to your workflow",
    category: "utilities",
    icon: "⏱️",
    logoUrl: "",
    version: "1.0.0",
    ...
    actions: [
      ...
      {
        key: "wait_until",
        name: "Wait Until Date/Time",
        description: "Wait until a specific date and time",
        properties: [
          {
            key: "datetime",
            label: "Date & Time",
            description: "When to resume the workflow",
            type: "datetime",
            required: true,
            supportsExpressions: true,
          },
        ...
        sampleOutput: {
          startedAt: "2025-01-15T14:00:00Z",
          targetTime: "2025-01-16T09:00:00Z",
          completedAt: "2025-01-16T09:00:00Z",
        },
        requiresConnection: false,
      },
      {
        key: "wait_after_queue",
        name: "Wait After Queue",
        description: "Wait for other tasks in the queue to complete",
        properties: [
          {
            key: "queueName",
            label: "Queue Name",
            description: "Name of the queue to wait for",
            type: "text",
            required: true,
          ...
          },
          {
            ...
            description: "Maximum time to wait (optional)",
            type: "text",
            required: false,
    ...
    docsUrl: "https://docs.swiftflow.ai/utilities/wait",
    supportUrl: "https://support.swiftflow.ai",
    author: "Swift Flow AI",
    installCount: 18000,
    rating: 4.9,
