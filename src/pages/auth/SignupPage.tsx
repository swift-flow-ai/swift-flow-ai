...
import { Mail, Lock, User, ArrowRight, Sparkles, Shield, Zap, CheckCircle, Eye, EyeOff } from 'lucide-react';
...
export default function SignupPage() {
  ...
  const handleGoogleSignup = async () => {
    ...
    try {
      ...
      const err = error as { message?: string };
      setApiError(err.message || 'Google signup failed. Please try again.');
    } finally {
      setIsLoading(false);
    }
  };
          ...
          >
            <div>
              ...
              <p className="text-lg text-white/90 leading-relaxed">
                Join thousands of teams automating their workflows with AI-powered automation.
              </p>
            </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-background overflow-y-auto">
        <div className="w-full max-w-md py-4">
          ...
          >
            ...
            <p className="text-sm text-muted-foreground">Get started with Swift Flow AI today</p>
          </motion.div>
              ...
              <div className="flex items-start">
                <label className="flex items-start cursor-pointer group">
                  <input
                    ...
                    className="w-4 h-4 mt-1 text-primary bg-background border-border rounded focus:ring-2 focus:ring-primary focus:ring-offset-0 transition-colors"
                  />
